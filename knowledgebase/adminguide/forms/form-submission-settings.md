---
description: Learn how to adjust your Form Submission Settings
---
...
{% hint style="info" %}
See [Salesforce Integration](salesforce-integration.md) for full details on mapping form submissions to Salesforce records.
{% endhint %}
