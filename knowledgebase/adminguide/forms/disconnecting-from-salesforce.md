---
description: Learn how to Disconnect your Maica Forms account from Salesforce
---
...
Follow the steps in [Connecting to Salesforce](connecting-to-salesforce.md). You can reconnect to the same org or a different one. If you reconnect to a different org, make sure any field mappings in your forms still refer to valid object and field names in the new org.
