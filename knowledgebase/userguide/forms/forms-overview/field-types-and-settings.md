...
See [Salesforce Integration](https://app.gitbook.com/s/9selzjEx6KX7RYEawAVr/forms/salesforce-integration) for details on mapping fields to Salesforce objects.
...
{% hint style="info" %}
To learn more about the Salesforce Integration in Maica Forms, [click here](https://app.gitbook.com/s/9selzjEx6KX7RYEawAVr/forms/salesforce-integration).&#x20;
{% endhint %}
