...
An Invoice in **Maica** represents the financial component following an instance of Service Delivery. It is comprised of [Invoice Line Items](/broken/pages/hWA58KRHtrlYv3dz8GS9), one for each delivered Service across a billing period which dictates how long an Invoice is `open` for before being finalised. It also houses [Payment Request](payment-request-overview.md) records.&#x20;
