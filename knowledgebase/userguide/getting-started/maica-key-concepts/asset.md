...
{% hint style="info" %}
Typical Assets might be cars being used to deliver services, rooms being booked, as well as any equipment beign taken to [Appointments](https://app.gitbook.com/s/hehRshYIRk6XUlay9L3b/appointments) and [Shifts](https://app.gitbook.com/s/hehRshYIRk6XUlay9L3b/shifts), such as medical equipment.
{% endhint %}

### Purpose

The purpose of Assets is to capture the various non-human [Resources](https://app.gitbook.com/s/hehRshYIRk6XUlay9L3b/resources) delivering services. This has been architected as a record type on the [Resource](https://app.gitbook.com/s/hehRshYIRk6XUlay9L3b/resources) data object rather than using the native Salesforce Contact. The main reason for this is to separate the workforce (human and non-human) from the overall Contacts/Participants in the system. Assets also capture fundamentally different information which lends itself moreso to a specific data object to manage this.
...
{% hint style="info" %}
In many ways, Maica treats Assets just like [Resources](https://app.gitbook.com/s/hehRshYIRk6XUlay9L3b/resources) with some reduced functionality, such as capturing personal information as this does not apply to non-human [Resources](https://app.gitbook.com/s/hehRshYIRk6XUlay9L3b/resources).
{% endhint %}

### Final Thoughts

There are many use cases where not only human care workers ([Resources](https://app.gitbook.com/s/hehRshYIRk6XUlay9L3b/resources)) are involved in the delivery of services but also non-human ones, such as cars, rooms, equipment, among many others. Maica offers the ability to treat these non-human [Resources](https://app.gitbook.com/s/hehRshYIRk6XUlay9L3b/resources) just like your care team buy including them in the scheduling, filtering, and rostering of your services.
