---
description: >-
  Learn how to complete the Check-Out process at the end of your Appointment or
  Shift on the Maica Mobile App
---
...
Before finalising, you will confirm the Date and Time your Appointment or Shift finished.

By default, **Maica** uses the **Scheduled End Time** of your Appointment, which is the value you will need if you finished on time. If you finished at a different time, you can edit the field directly, or set it back to the scheduled time by selecting the link below the field.

{% hint style="success" %}
A time you have entered yourself is kept while you complete the rest of your Check-Out. Moving into another action, such as Participant Notes, and coming back will not clear it.
{% endhint %}

{% hint style="info" %}
On a group Appointment where a colleague has already checked out, this field defaults to the current time instead, so that their finish time is never applied to yours.
{% endhint %}
...
{% hint style="info" %}
Travel is calculated dynamically using Appointment locations and Google API data. To learn how to manage this information, please refer to the [Manage Travel](check-out.md#manage-travel) section below.
{% endhint %}
...
Once you have completed all required actions, press **Check-Out** to finalise. The Date and Time shown on screen is the time recorded against your Appointment or Shift. You will be returned to the Appointment or Shift overview screen, where the status will update to **Appointment Completed**.
